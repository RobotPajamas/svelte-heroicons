...
async function build() {
  await generateFromFolder("node_modules/heroicons/solid", "src/lib/solid", options);
  ...
  await generateFromFolder("node_modules/heroicons/outline", "src/lib/outline", options);
